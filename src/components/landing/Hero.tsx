...
export function Hero() {
  return (
    <Container className='pb-16 pt-20 text-center lg:pt-32'>
      <h1
        className='mx-auto mt-24 max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl'>
        Hiring developers{' '}
      ...
      <div className='mt-10 flex justify-center gap-x-6'>
        <Button className='' loading={false} variant='solid' color='vlue' href='/register'>Hire Developers</Button>
