...
import BgImage from '@/components/landing/BgImage';
...
const faqs = [
  [
    ...
    },
    {
      ...
      answer:
        'We are planning on adding premium features like sponsored positions later.',
    },
  ],
  [
    {
      question: 'What if my developers are not available anymore ?',
      answer: 'You can edit their status and visability.',
    },
    {
      question:
  ...
  [
    {
      question:
        'What if somebody will see my available developers and solicit them ?',
      answer:
