              ...
              <div className='mt-2'>
                <div className='grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6'>
                  <button
                    ...
                    type='button'
                    className='block w-full rounded-md py-2 px-3 text-base font-medium bg-red-700 hover:bg-red-800 text-white transition-colors duration-150'
                  >
                    Delete Developer
                  </button>
                </div>
        ...
        <div className='space-x-2'>
          <button
            ...
            className={`${
              disabledSave
                ? 'cursor-not-allowed'
                : 'cursor-pointer text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
            } group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md transition duration-150 ease-in-out`}>
            {uploading ? (
              <svg
