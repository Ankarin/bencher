export default function Privacy() {
    return (
        ...
        <div className={'p-10'}>
            ...
            <p> Bencher (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how
                your personal information is collected, used, and disclosed by Bencher.</p>
            <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”)
                alongside our application, Bencher. By accessing or using our Service, you signify that you have read,
            ...
            <p>To help explain things as clearly as possible in this Privacy Policy, every time any of these terms are
                ...
                <ul>
                    ...
                    <li>Country: where Bencher or the owners/founders of Bencher are based, in this case is United
                        States
                    </li>
                    <li>Customer: refers to the company, organization or person that signs up to use the Bencher Service
                    ...
                    <li>Device: any internet connected device such as a phone, tablet, computer or any other device that
                        can be used to visit Bencher and use the services.
                    </li>
                    ...
                    <li>Personnel: refers to those individuals who are employed by Bencher or are under contract to
                    ...
                    <li>Service: refers to the service provided by Bencher as described in the relative terms (if
            ...
            <h1>When does Bencher use end user information from third parties?</h1>
            <p>Bencher will collect End User Data necessary to provide the Bencher services to our customers.</p>
            ...
            <h1>When does Bencher use customer information from third parties?</h1>
            <p>We receive some information from the third parties when you contact us. For example, when you submit your
                email address to us to show interest in becoming a Bencher customer, we receive information from a third
                party that provides automated fraud detection services to Bencher. We also occasionally collect
            ...
            <p>Bencher will collect personal information that you submit to us. We may also receive personal information
            ...
            <p>We keep your information only so long as we need it to provide Bencher to you and fulfill the purposes
            ...
            <p>We implement a variety of security measures to maintain the safety of your personal information when you
                ...
                any information you transmit to Bencher or guarantee that your information on the Service may not be
            ...
            <p>Bencher is incorporated in United States. Information collected via our website, through direct
            ...
            <h1>Is the information collected through the Bencher Service secure?</h1>
            ...
            <p>The rights you have to request updates or corrections to the information Bencher collects depend on your
                relationship with Bencher. Personnel may update or correct their information as detailed in our internal
            ...
            <h1>Personnel</h1>
            <p>If you are a Bencher worker or applicant, we collect information you voluntarily provide to us. We use
            ...
            <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other
                transfer of all or substantially all of the assets of Bencher or any of its Corporate Affiliates (as
                defined herein), or that portion of Bencher or any of its Corporate Affiliates to which the Service
            ...
            <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For
                ...
                indirectly controls, is controlled by or is under common control with Bencher, whether by ownership or
            ...
            <p>By using Bencher or contacting us directly, you signify your acceptance of this Privacy Policy. If you do
            ...
            <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not
                operated or controlled by Bencher. We are not responsible for the content, accuracy or opinions
            ...
            <h1>Cookies</h1>
            <p>Bencher uses "Cookies" to identify the areas of our website that you have visited. A Cookie is a small
            ...
            <p>We may display, include or make available third-party content (including data, information, applications
                ...
                Services").</p>
            <p>You acknowledge and agree that Bencher shall not be responsible for any Third-Party Services, including
                their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or
                any other aspect thereof. Bencher does not assume and shall not have any liability or responsibility to
            ...
            <p>GDPR adds some new requirements regarding how companies should protect individuals' personal data that
                ...
                imposing greater fines for breach. Beyond these facts it's simply the right thing to do. At Bencher we
            ...
            <p>We are committed to helping our customers meet the data subject rights requirements of GDPR. Bencher
