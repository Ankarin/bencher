    ...
    <div className={'p-10'}>
      ...
      <ul>
        ...
        <li>
          ...
          refers to BitBencher, that is responsible for your information under
          this Cookie Policy.
        </li>
        <li>
          Device: any internet connected device such as a phone, tablet,
          computer or any other device that can be used to visit BitBencher and
          use the services.
        </li>
        <li>
        ...
        <li>
          Service: refers to the service provided by BitBencher as described in
      ...
      <ul>
        ...
        <li>
          You: a person or entity that is registered with BitBencher to use the
          Services.
        </li>
      </ul>
      ...
      <p>
        ...
        party basis by BitBencher. The Websites can be embedded with content
